...
// Ptr<OutputStreamWrapper> stream = asciitracehelper.CreateFileStream("output");
std::ofstream myfile;
...
main (int argc, char *argv[])
{
  ...
  // sink = StaticCast<PacketSink> (sinkApp.Get (0));
   ...
   Ptr<PcapFileWrapper> file = pcapHelper.CreateFile ("./output/hello.pcap", std::ios::out, PcapHelper::DLT_PPP);
